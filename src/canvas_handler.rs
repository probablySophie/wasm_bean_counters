...
use crate::{js, CANVAS_HEIGHT, CANVAS_WIDTH};

pub fn setup() -> (i32, i32)
{
	...
	let width:u32  = (f64::from(CANVAS_WIDTH)  * device_pixel_ratio) as u32;
	let height:u32 = (f64::from(CANVAS_HEIGHT) * device_pixel_ratio) as u32;
